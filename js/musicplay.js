...
// function songs(liy) {
// 	musicName.innerHTML = arr[liy];
// 	player.src = 'images/stpp.png';
// 	audio.src = 'lib/'+arr[liy]+'.mp3';
// 	musictext.innerHTML = lyrics[liy];
// 	audio.play();
// }

a0.onclick = function songs() {
